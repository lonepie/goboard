...
var rootCmd = &cobra.Command{
	Use:   "goboard",
	Short: "A clipboard history manager",
	Long: `goboard is a clipboard history manager that monitors the clipboard for text
	and saves entries in a SQLite database.`,
